...
class RegionLineChart extends Component {
  ...
  render() {
    let { lineChartData, title } = this.props.route.params ? this.props.route.params : []
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        {Array.isArray(lineChartConfig.series[0].data) && lineChartConfig.series[0].data.length ?
          <ChartWeb
            originWhitelist={['']}
